...
nohup indiserver -v -l /home/dokeeffe indi_ioptronv3_telescope indi_script_dome indi_sx_ccd indi_atik_ccd indi_atik_wheel indi_moonlite_focus indi_weather_safety_proxy indi_sqm_weather indi_watchdog &
