...
def generate_flats():
    ...
    for rawdir_to_process in rawdirs_to_process:
        ...
        if not flat_ic.files:
            ...
            logging.info('flat image file collection info: '+ str(flat_ic.summary))
            ...
            for k, v in flats.items():
                ...
                bias_subtracted_master_flat.write('master_flat_' + date_file_prefix + k + '.fits')
                if bias_subtracted_master_flat.header['XBINNING'] == 1:
                    ...
                    scaled.write('master_flat_' + date_file_prefix + k +'_rescaled2X.fits')
